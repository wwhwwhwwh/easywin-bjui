...
import com.westar.base.context.PaginationContext;
...
public class BaseDao {
	...
	public Integer add(final String tableName, final String[] fields, Object object) {
		...
		namedParameterJdbcTemplate.update(createInsertSql(tableName, fields), beanPropertySqlParameterSource, keyHolder, new String[] { "id" });
	...
	public void delById(String tableName, Integer id) {
		jdbcTemplate.update(createDeleteSql(tableName, new String[] { "id" }), id);
	}
	...
	public void delById(String tableName, Integer[] ids) {
		...
		jdbcTemplate.batchUpdate(createDeleteSql(tableName, new String[] { "id" }), batchArgs);
	}
	...
	public void delByField(String tableName, String field, Object fieldValue) {
		jdbcTemplate.update(createDeleteSql(tableName, new String[] { field }), fieldValue);
	}

	public void delByField(String tableName, String[] fields, Object[] fieldValues) {
		jdbcTemplate.update(createDeleteSql(tableName, fields), fieldValues);
	}
	/**
	 * 批量删除
	 * @param tableName
	...
	public void delBatchByField(String tableName, String[] fields, Object[] fieldValues) {
		...
		jdbcTemplate.batchUpdate(createDeleteSql(tableName, fields), batchArgs);
	}
	...
	protected void update(StringBuffer sql, Object object) {
		BeanPropertySqlParameterSource beanPropertySqlParameterSource = new BeanPropertySqlParameterSource(object);
		namedParameterJdbcTemplate.update(sql.toString(), beanPropertySqlParameterSource);
	}
	...
	public void update(String tableName, String[] fields, Object object) {
		...
		BeanPropertySqlParameterSource beanPropertySqlParameterSource = new BeanPropertySqlParameterSource(object);
		namedParameterJdbcTemplate.update(sql, beanPropertySqlParameterSource);
	}
	/**
	 * 根据id更新数据
	 * @param object
...
//		String countQueryString = "select  count(*) " + tail;
	...
	protected List pagedQuery(String sql, String orderby, Object[] args, Class c) {
		...
		List data = jdbcTemplate.query(this.createOraclePaginationSql(sql, orderby), args, rowMapper);
	...
	protected List listQuery(String sql, Object[] args, Class c) {
		RowMapper rowMapper = BeanPropertyRowMapper.newInstance(c);
		List data = jdbcTemplate.query(sql, args, rowMapper);
		return data;
	}
	...
	protected JSONObject objectQueryJSON(String sql, Object[] args) {
		try {
			return jdbcTemplate.queryForObject(sql, args, new RowMapper<JSONObject>() {
				@Override
	...
	protected List<JSONObject> listQueryJSON(String sql, Object[] args) {
		try {
			return jdbcTemplate.query(sql, args,new RowMapper<JSONObject>() {
