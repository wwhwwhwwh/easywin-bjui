package com.westar.base.model.system;
...
public interface CommonConstant {
	 ...
	 * 手机端用户唯一标识存放
	 */
	public final static String SESSION_USER_KEY="easywin_session_user";
	/**
	 * 手机端用户唯一标识存放
	 */
	public final static Integer SESSION_USER_EXPRESS=30;
}
